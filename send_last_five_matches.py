...
if __name__ == '__main__':
    ...
    if player_arg in unauthorized :
        ...
        keyboard = [InlineKeyboardButton(text=' + text_arr[arr_val] + ', callback_data='" + message_arr[arr_val] + ')]

        keyboard = InlineKeyboardMarkup(inline_keyboard=[
                   [InlineKeyboardButton(text=text_arr[0], callback_data=message_arr[0]), InlineKeyboardButton(text=text_arr[1], callback_data=message_arr[1])],
                   [InlineKeyboardButton(text=text_arr[2], callback_data=message_arr[2]), InlineKeyboardButton(text=text_arr[3], callback_data=message_arr[3])],
                   [InlineKeyboardButton(text=text_arr[4], callback_data=message_arr[4])],
               ])
